...
- Displays a visual grid, showing the status and commits of your services across all environments
- Generates a **compare URL** that allows you to inspect code differences between preproduction and production ahead of deployment to production.
- The URL can be copied to your clipboard or opened directly in your default browser.

<img width="1897" height="1041" alt="service-status" src="https://github.com/user-attachments/assets/46d87897-4f02-4fd6-a07f-420c827f23dc" />
...
<img width="1897" height="1041" alt="token-generator" src="https://github.com/user-attachments/assets/a68f9131-5043-4fc9-85e9-317b98bc9a8f" />
