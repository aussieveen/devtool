...
│                      │                                                                          │
│                      │  Description:                                                            │
│                      │  The login flow on the homepage breaks when the session token has       │
│                      │  expired. Users are redirected to a blank page instead of the login...  │
│                      │                                                                          │
│                      │  [a] Add ticket   [x] Remove   [o] Open in browser   [shift+↑↓] Reorder│
└──────────────────────┴──────────────────────────────────────────────────────────────────────────┘
 Help ─────────────────────────────────────────────────────────────────────────────────────────────
 [← →] Switch panels   [↑ ↓] Move in list   [d] Dismiss popup   [esc|q] Quit
```
